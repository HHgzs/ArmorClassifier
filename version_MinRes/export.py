...
def convert_pth_to_onnx(pth_path, onnx_path, model):
...
if __name__ == '__main__':
    ...
    pth_path = './models/model_epoch_8_acc_99.03.pth'
    onnx_path = './outputs/classify_resnet18_epoch8.onnx'
    model = resnet18(num_classes=8)
    
    convert_pth_to_onnx(pth_path, onnx_path, model)
